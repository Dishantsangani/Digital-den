      ...
      <section className="bg-white mb-5">
        <div className="container px-6 mx-auto">
          ...
          <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 ">
            Our executive team is a group of experienced leaders committed to
            driving innovation, growth, and excellence.
          </p>
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-indigo-600 rounded-xl">
              <img
                className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://media.licdn.com/dms/image/v2/D4E03AQG6jqsACCtZBQ/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1686221221546?e=2147483647&v=beta&t=b3Tw-LBZhjs-GINnCjBB_nESQGglAHe6CMJC0WMEh68"
                alt=""
              />
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">
                Olivia Wathan
